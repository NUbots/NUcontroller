...
void dxlAddInstFunc(dxl_t* p_packet, uint8_t inst, dxl_error_t (*func)(dxl_t* p_dxl)) {
    ...
    switch (inst) {
        case INST_PING: p_packet->inst_func.ping = (dxl_error_t(*)(void*)) func; break;

        case INST_READ: p_packet->inst_func.read = (dxl_error_t(*)(void*)) func; break;

        case INST_WRITE: p_packet->inst_func.write = (dxl_error_t(*)(void*)) func; break;

        case INST_REG_WRITE: p_packet->inst_func.reg_write = (dxl_error_t(*)(void*)) func; break;

        case INST_ACTION: p_packet->inst_func.action = (dxl_error_t(*)(void*)) func; break;

        case INST_RESET: p_packet->inst_func.factory_reset = (dxl_error_t(*)(void*)) func; break;

        case INST_REBOOT: p_packet->inst_func.reboot = (dxl_error_t(*)(void*)) func; break;

        case INST_STATUS: p_packet->inst_func.status = (dxl_error_t(*)(void*)) func; break;

        case INST_SYNC_READ: p_packet->inst_func.sync_read = (dxl_error_t(*)(void*)) func; break;

        case INST_SYNC_WRITE: p_packet->inst_func.sync_write = (dxl_error_t(*)(void*)) func; break;

        case INST_BULK_READ: p_packet->inst_func.bulk_read = (dxl_error_t(*)(void*)) func; break;

        case INST_BULK_WRITE: p_packet->inst_func.bulk_write = (dxl_error_t(*)(void*)) func; break;
    }
}
...
dxl_error_t dxlProcessInst(dxl_t* p_packet) {
    ...
    switch (inst) {
        case INST_PING: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.ping; break;

        case INST_READ: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.read; break;

        case INST_WRITE: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.write; break;

        case INST_REG_WRITE: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.reg_write; break;

        case INST_ACTION: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.action; break;

        case INST_RESET: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.factory_reset; break;

        case INST_REBOOT: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.reboot; break;

        case INST_STATUS: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.status; break;

        case INST_SYNC_READ: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.sync_read; break;

        case INST_SYNC_WRITE: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.sync_write; break;

        case INST_BULK_READ: func = (dxl_error_t(*)(dxl_t*)) p_packet->inst_func.bulk_read; break;
    ...
    switch (p_packet->rx_state) {
        case PACKET_STATE_IDLE:
            ...
            if (p_packet->header_cnt >= 2) {
                ...
                if (p_packet->rx.header[0] == 0xFF && p_packet->rx.header[1] == 0xFF
        ...
        default: p_packet->rx_state = PACKET_STATE_IDLE; break;
    }
