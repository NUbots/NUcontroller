    ...
    public:
        ...
        NUsenseIO()
            ...
            chains({std::vector<platform::NUsense::NUgus::ID>{platform::NUsense::NUgus::ID::R_SHOULDER_PITCH,
                    ...
                    std::vector<platform::NUsense::NUgus::ID>{platform::NUsense::NUgus::ID::R_KNEE,
                                                              platform::NUsense::NUgus::ID::R_ANKLE_PITCH,
                                                              platform::NUsense::NUgus::ID::R_ANKLE_ROLL},
                    std::vector<platform::NUsense::NUgus::ID>{platform::NUsense::NUgus::ID::L_KNEE,
         ...
         */
        void process_servo_data(std::array<platform::ServoState, NUMBER_OF_DEVICES>& servo_states,
