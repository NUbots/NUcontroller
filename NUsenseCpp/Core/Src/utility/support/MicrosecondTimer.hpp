...
#ifndef UTILITY_SUPPORT_TIMER_HPP
#define UTILITY_SUPPORT_TIMER_HPP
...
namespace utility::support {
    ...
    public:
        ...
        inline bool has_timed_out() {
            //bool has_timed_out = (is_counting) && (__HAL_TIM_GET_COUNTER(htim) > threshold);
            //is_counting = __HAL_TIM_GET_COUNTER(htim) <= threshold;
...
#endif // UTILITY_SUPPORT_TIMER_HPP
