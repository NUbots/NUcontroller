...
namespace test_hw {
    ...
    void motor_v2() {
        ...
        new (inst_packet.data()) dynamixel::Packet<uint8_t, 4>(0x01, dynamixel::WRITE, params);
        ...
        dynamixel::Packet<uint8_t, 1> sts_packet =
            *reinterpret_cast<dynamixel::Packet<uint8_t, 1>*>(packetiser.get_decoded_packet());
        ...
        new (inst_packet.data()) dynamixel::Packet<uint8_t, 3>(0x01, dynamixel::WRITE, params_1);
        ...
        while (1) {
            ...
            if (port.get_available_rx() >= sizeof(dynamixel::Packet<uint8_t, 1>)) {
                ...
                // Cast to a packet-structure.
                sts_packet = *reinterpret_cast<dynamixel::Packet<uint8_t, 1>*>(packetiser.get_decoded_packet());
                // Maybe check the CRC here if this is a proper protocol-handler.
                // Reset the decoder.
                packetiser.reset();
