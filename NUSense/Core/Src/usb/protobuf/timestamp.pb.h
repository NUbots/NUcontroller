...
#ifndef PB_GOOGLE_PROTOBUF_NUSENSE_MESSAGES_TIMESTAMP_PB_H_INCLUDED
#define PB_GOOGLE_PROTOBUF_NUSENSE_MESSAGES_TIMESTAMP_PB_H_INCLUDED
#include "pb.h"
...
#define GOOGLE_PROTOBUF_NUSENSE_MESSAGES_TIMESTAMP_PB_H_MAX_SIZE google_protobuf_Timestamp_size
